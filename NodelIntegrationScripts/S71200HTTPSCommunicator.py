...
class S71200HTTPSCommunicator:

    IP_ADDRESS_REPLACEMENT_TOKEN = "IP_ADDRESS"
    PLC_LOGIN_ADDRESS_TEMPLATE = "HTTPS://" + IP_ADDRESS_REPLACEMENT_TOKEN + "/FormLogin"
    PLC_LOGOUT_ADDRESS_TEMPLATE = "HTTPS://" + IP_ADDRESS_REPLACEMENT_TOKEN + "/FormLogin?LOGOUT"
