...
public class PneumanBlackoutCommunicatorUnitTests {
    ...
    public void TestSuccessfulLogin() throws Exception {
        ...
        verify(_mockLoginClient).execute(any(HttpPost.class));
    }
    ...
    public void TestSuccessfulCommand() throws Exception {
        ...
        verify(_mockCommandClient).execute(any(HttpPost.class));
    }
    ...
    public void TestSuccessfulLogout() throws Exception {
        ...
        verify(_mockLogoutClient).execute(any(HttpPost.class));
    }

    @Test(expected=IOException.class)
    public void TestFailedConnection() throws Exception {

        doThrow(new IOException()).when(_mockLoginClient).execute(any(HttpPost.class));
